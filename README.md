...
- [Vita3K android](https://github.com/Vita3K/Vita3K-Android) ⭐️- PS Vita エミュレーター。
- [DuckStation](https://play.google.com/store/apps/details?id=com.github.stenzek.duckstation&hl=en_AU&gl=US) - PS1エミュレーター。
- [NetherSX2](https://github.com/Trixarian/NetherSX2-patch) ⭐️- PS2エミュレーター。AetherSX2の改造版。パッチを当てる必要がある。AetherSX2 は公式ページのアーカイブからダウンロードすると良い。
...
- [WEB画像検索・ダウンローダ](https://play.google.com/store/apps/details?id=com.beta9dev.imagedownloader) Proprietary`- 改悪されているので微妙。1DMのファイル抽出のほうがおすすめ。
- Nekogram マルウェア
- Cherrygram マルウェア
